...
void Contar(Triangulo *arr[],int cant,Cuadrado *ar[],int cant1){
	int cont=0,cont2=0,total;
	for (int i=0 ; i<cant ; i++){
		cont=cont+arr[i]->mayor50();
	}
	cout<<"La cantidad de superficies del TRIANGULO mayor a 50 son:"<<cont<<endl;
	for( int j=0 ;j<cant1;j++){
		cont2=cont2+ar[j]->mayor50();
	}
	cout<<"La cantidad de superficies del CUADRADO mayor a 50 son:"<<cont2<<endl;
 	total=cont+cont2;
	cout<<"La cantidad de superficies mayor a 50 son > "<<total<<endl;
}
